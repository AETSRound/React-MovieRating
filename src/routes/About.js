    ...
    return (
        <div>
            <p className="about__container">
                <a href="http://github.com/tonypark-cw"><img alt="ToRootGit" className="root_git" src="http://localhost:3000/react-movierating/Octocat.jpg"></img></a>
                이 사이트는 개발용 입니다.<br/>
                Nomad Coder Nicolas의 Movie Rating Web <br/>
                강의를 통한 클론 코딩 페이지입니다.
                <span>
                    <span>개발자 :  TonyPark</span>
                    <span><a href="http://github.com/tonypark-cw/react-movierating"><img className="git_Icon" alt="ToMovieRatingGit" src="http://localhost:3000/react-movierating/GitHub-Mark-32px.png"></img></a></span><br/>
